...
_router.get('/login/kakao', _passport.authenticate('kakao'));
_router.get('/login/kakao/callback', ctrl.kakaoLoginCallback);

_router.get('/login/google', _passport.authenticate('google', { scope: ['profile', 'email'] }));
_router.get('/login/google/callback', ctrl.googleLoginCallback);

_router.get('/login/naver', _passport.authenticate('naver'));
